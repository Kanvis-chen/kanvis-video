...
Use these drafts after replacing `https://github.com/Kanvis-chen/article-to-avatar-video` with the public GitHub URL.

## Chinese Short Post

我开源了 Article to Avatar Video。

它不是让数字人把文章念一遍，而是把中文长文重新导演成视频：
...
仓库里有无隐私示例、配置前检、分镜校验、质量报告和 CI。

GitHub：https://github.com/Kanvis-chen/article-to-avatar-video

## English Short Post

I open-sourced Article to Avatar Video.

It is a Codex Skill that turns Chinese long-form content into visually directed, release-gated avatar videos.
...
-> spoken adaptation
-> semantic storyboard
-> avatar + information graphics + PIP
-> captions/audio
-> release QA
```
...
https://github.com/Kanvis-chen/article-to-avatar-video

## Longer Chinese Post

我开源了一个 Codex Skill：Article to Avatar Video。
