...
function usage() {
  console.error('Usage: node scripts/set-repository-url.mjs https://github.com/<owner>/article-to-avatar-video');
}
...
if (pathParts.length !== 2 || pathParts[1] !== 'article-to-avatar-video') {
  console.error('Repository URL should look like https://github.com/<owner>/article-to-avatar-video');
  process.exit(2);
}
